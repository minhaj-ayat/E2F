    ...
    while True:
        ...
        with conn_proxy:
            ...
            while True:
                ...
                print('Foreign fog received challenge/200 ok  from proxy: ')
                ...
                if not authChallenge:
                    ...
                    print(authChallenge)
                    if authChallenge == '200 OK' or authChallenge == "Valid":
                    ...
                    with socket(AF_INET, SOCK_STREAM) as fog_clientSocket:
                        ...
                        print('Foreign fog sent data to UE: ')
                        print(datetime.datetime.now())
